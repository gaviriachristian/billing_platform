...
Route::group(['prefix' => 'auth'], function () {
  ...
  Route::post('custom-signin', [AuthController::class, 'createSignin'])->name('auth-signin-custom');
  Route::get('register', [AuthController::class, 'signup'])->name('auth-register');
  Route::post('create-user', [AuthController::class, 'customSignup'])->name('auth-user-registration');
  Route::get('logout', [AuthController::class, 'logout'])->name('auth-logout');

  Route::get('verification-notice', [AuthenticationController::class,'login_v2'])->name('verification.notice');
});
/* Route Authentication Pages */
