...
<section id="nacha-datatable">
  ...
  <div class="modal modal-slide-in fade" id="modals-slide-in">
    <div class="modal-dialog sidebar-sm">
      <form id="import-csv-form" method="POST" class="add-new-record modal-content pt-0" action="{{ route('nacha-import-csv') }}" accept-charset="utf-8" enctype="multipart/form-data">
      @csrf
